        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-block px-4 py-2 mb-6 bg-primary/10 border border-primary/20 rounded-full">
              <span className="text-primary font-medium text-sm">About Colosseum Integrated Business</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              At Colosseum Integrated Business, we're pioneering the next generation of artificial 
